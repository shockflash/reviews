"""
Taken from https://raw.github.com/simonw/django-openid/master/django_openid/signed.py

Will be replaced with djangos own signer when it is part of the stable!
"""
